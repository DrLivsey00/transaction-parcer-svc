...
GENERATED="${GOPATH}/src/github.com/DrLivsey00/transaction-parcer-svc/resources"
OPENAPI_DIR="${GOPATH}/src/github.com/DrLivsey00/transaction-parcer-svc/docs/web_deploy"
